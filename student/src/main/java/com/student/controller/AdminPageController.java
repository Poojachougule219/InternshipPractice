...
public class AdminPageController {
    ...
    // =====================================================
    //
    // profilePhoto is byte[] in Student entity.
    //
    // This endpoint returns image bytes directly
    // to the browser.
    //
    // Supports:
    // JPEG
    ...
    //
    // IMPORTANT:
    // Keep ONLY this profile-photo endpoint.
    // =====================================================
    ...
    public ResponseEntity<byte[]> profilePhoto(
        ...
        if (admin == null
                || admin.getProfilePhoto() == null
                || admin.getProfilePhoto().length == 0) {
